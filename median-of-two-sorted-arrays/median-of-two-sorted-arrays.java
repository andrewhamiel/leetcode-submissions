class Solution {
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        while(left <= right){
            ...
            //Case 1: maxLeftA <= minRightB: Correct Partition
            ...
            //Case 2: maxLeftA > minRightB: minLeftA too large for partition A, need smaller partition
            else if(maxLeftA > minRightB) right = partitionA - 1;
            //Case 3: maxLeftB < minRightA: maxLeftA too small to be in larger half, need larger partition
