class Solution {
    ...
    public double[] calcEquation(List<List<String>> equations, double[] values, List<List<String>> queries) {
        ...
        for (int i = 0; i < queries.size(); i++) {
            ...
            if (!gidWeight.containsKey(dividend) || !gidWeight.containsKey(divisor)) results[i] = -1.0;
            else {
                ...
                if (!dividendGid.equals(divisorGid)) results[i] = -1.0;
                // case 3). there is a chain/path between the variables
                else results[i] = dividendWeight / divisorWeight;
            }
        }
    ...
    private Pair<String, Double> find(HashMap<String, Pair<String, Double>> gidWeight, String nodeId) {
        if (!gidWeight.containsKey(nodeId)) gidWeight.put(nodeId, new Pair<String, Double>(nodeId, 1.0));
    ...
    private void union(HashMap<String, Pair<String, Double>> gidWeight, String dividend, String divisor, Double value) {
        ...
        if (!dividendGid.equals(divisorGid)) gidWeight.put(dividendGid, new Pair(divisorGid, divisorWeight * value / dividendWeight));
    }
}